...
export const canisterId = process.env.CANISTER_ID_DECGOV_BACKEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./decgov_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the decgov_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./decgov_backend.did.js")._SERVICE>}
 */
export const decgov_backend = createActor(canisterId);
